    ...
    ! function(i) {
        ...
        i.fn.cardSlider = function(s) {
            ...
            return this.params = i.extend({}, t, s || {}), this.slider = i(this), this.slides = [], this.count = 0, this.current = this.params.current || 1, this.transitionEvent = null, this.init = function() {
                ...
                this.slides.removeClass("left-hidden-slide center-slide left-slide right-slide right-hidden-slide").addClass("hidden-slide")
                ...
                var t = this.getIndexPosition(i),
                    s = this.getIndex(t),
                    n = this.getSlideByIndex(s);
                return n
                ...
                var i, t = document.createElement("transitionCheckElement"),
                    s = {
                ...
                for (i in s)
                    if (void 0 !== t.style[i]) return s[i]
            }, this.init(), this
        }
    }(jQuery)
} catch (i) {
