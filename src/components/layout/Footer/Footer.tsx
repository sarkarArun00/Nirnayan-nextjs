                ...
                <div className="accordion-item">
                    <h2 className="accordion-header" id="headingTests">
                        <button className="accordion-button" type="button" data-bs-toggle="collapse"
                            data-bs-target="#collapseTests" aria-expanded="true" aria-controls="collapseTests">
                            <div className="title-pnl">
                                <img src="/assets/images/blood-sample.png" className="img-fluid" alt="" />
                                <h5>Top Tests</h5>
                            </div>
                        </button>
                    </h2>
                    <div id="collapseTests" className="accordion-collapse collapse show" data-bs-parent="#nirnayanAccordion"
                 ...
                 <div className="accordion-item">
                    <h2 className="accordion-header" id="headingPackages">
                        <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            data-bs-target="#collapsePackages" aria-expanded="false" aria-controls="collapsePackages">
                            <div className="header-left d-flex align-items-center gap-2">
                                <div className="title-pnl">
                                    <img src="/assets/images/package.png" className="img-fluid" alt="" />
                                    <h5>Top Packages</h5>
                                </div>
                            </div>
                        </button>
                    </h2>
                    <div id="collapsePackages" className="accordion-collapse collapse" data-bs-parent="#nirnayanAccordion"
                        aria-labelledby="headingPackages">
                        <div className="accordion-body">
                            <ul>
                ...
                <div className="accordion-item">
                    <h2 className="accordion-header" id="headingInfo">
                        <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <div className="title-pnl">
                                <img src="/assets/images/info-icon.png" className="img-fluid" alt="" />
                                <h5>Know More About Nirnayan</h5>
                            </div>
                        </button>
                    </h2>
                    <div id="collapseInfo" className="accordion-collapse collapse" data-bs-parent="#nirnayanAccordion"
                        aria-labelledby="headingInfo">
                        <div className="accordion-body">
                            <div className="content-box info-blocks">
                                <h5>Who We Are</h5>
                                <p>Nirnayan Pathology is dedicated to delivering top-notch pathology services to
                                    stand as the Leading pathology lab in Kolkata. Committed to accuracy and
                                    excellence, we offer trouble-free blood collection from home. From routine to
                                    specialized tests, our state-of-the-art pathology ensures quality services near
                                    you with easy access. Discover reliable and trusted results with Nirnayan and
                                    secure your health for tomorrow.</p>
                                <h5>Mission</h5>
                                <p>Our commitment is to be the best pathology center in Kolkata by offering a
                                    meticulously structured and fully managed pathology service with diverse
                                    technology. Nirnayan is renowned for its adept management and specialized
                                    knowledge across various clinical environments. We offer the convenience to book
                                    a blood test and receive reliable results without any hassle.</p>
                                <h5>Accreditation</h5>
                                <p>Accreditation is a process by which healthcare organizations undergo rigorous
                                    evaluation to ensure they meet established standards for quality and safety.
                                    Nirnayan presents an accredited lab in Kolkata to implement policies,
                                    procedures, and practices that prioritize patient safety, quality of care, and
                                    positive outcomes. We remain dedicated to upholding the standards set and
                                    continually striving for excellence in all aspects of our services.</p>
                                <a href="#" className="more-info-link">About More Information</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="accordion-item">
                    <h2 className="accordion-header" id="headingAddress">
                        <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <div className="title-pnl">
                                <img src="/assets/images/address.png" className="img-fluid" alt="" />
                                <h5>Address Details</h5>
                            </div>
                        </button>
                    </h2>
                    <div id="collapseAddress" className="accordion-collapse collapse" data-bs-parent="#nirnayanAccordion"
                            ...
                            <div className="row g-3">
                                <div className="col-xl-3 col-lg-6 col-sm-6 col-12">
                                    <div className="address-card">
                                        <h5>Head Office:</h5>
                                        <p>
                                            145, Rajarhat Main Rd, Zarda Bagan,
                                            Jyangra, Baguiati, Kolkata,
                                            West Bengal 7000136
                                        </p>
